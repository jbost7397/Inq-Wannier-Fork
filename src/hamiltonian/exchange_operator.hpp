...
namespace hamiltonian {
  ...
  public:
		...
		exchange_operator(systems::cell const & cell, ionic::brillouin const & bzone, double const exchange_coefficient, bool const use_ace, std::optional<wannier::tdmlwf_trans> mlwf = std::nullopt, double const epsilon = 0.0):
