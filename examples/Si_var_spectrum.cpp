...
int main(int argc, char ** argv){
	...
	auto output = [&](auto data){
		...
		if(data.root()){
                        std::ofstream tfile("time_" + std::to_string(x_repeats) + "_" + std::to_string(y_repeats) + "_" + std::to_string(z_repeats) + "_mlwf.dat", std::ios::app);
                        std::ofstream dfile("dipole_" + std::to_string(x_repeats) + "_" + std::to_string(y_repeats) + "_" + std::to_string(z_repeats) + "_mlwf.dat", std::ios::app);
                        std::ofstream efile("energy_" + std::to_string(x_repeats) + "_" + std::to_string(y_repeats) + "_" + std::to_string(z_repeats) + "_mlwf.dat", std::ios::app);
                        std::ofstream cfile("current_" + std::to_string(x_repeats) + "_" + std::to_string(y_repeats) + "_" + std::to_string(z_repeats) + "_mlwf.dat", std::ios::app);
