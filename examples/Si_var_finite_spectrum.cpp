...
int main(int argc, char ** argv){
	...
	systems::ions ions(systems::cell::orthorhombic(x_dim, y_dim, z_dim).finite());
	...
	auto output = [&](auto data){
        ...
        real_time::propagate(ions, el, output, functional, options::real_time{}.num_steps(niter).dt(dt), kick);
