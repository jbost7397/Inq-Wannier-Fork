...
int main(int argc, char ** argv){
	...
	auto output = [&](auto data){
		...
		dip[iter] = data.dipole()[0];
                ...
                if (data.root()) {
                        std::ofstream tfile("time_benz.dat", std::ios::app);
                        std::ofstream dfile("dipole_benz.dat", std::ios::app);
                        std::ofstream efile("energy_benz.dat", std::ios::app);
                        std::ofstream cfile("current_benz.dat", std::ios::app);
