...
int main(int argc, char ** argv){
	...
	//LDA
	{
		...
		[[maybe_unused]] auto energy = electrons.calculate_ground_state(input::interaction::dft(), input::scf::mixing(0.10) | input::scf::conjugate_gradient() | input::scf::density_mixing());
