...
!ENDDEBUG
 ...
 LIBPAW_ALLOCATE(rhoarr,(npts))
 LIBPAW_ALLOCATE(rhom1_3,(npts))
 LIBPAW_ALLOCATE(rho_updnm1_3,(npts,2))
 LIBPAW_ALLOCATE(zetm,(npts))
 LIBPAW_ALLOCATE(zetmm1_3,(npts))
 LIBPAW_ALLOCATE(zetp,(npts))
 LIBPAW_ALLOCATE(zetpm1_3,(npts))
...
!ENDDEBUG
 ...
 LIBPAW_DEALLOCATE(rhom1_3)
 LIBPAW_DEALLOCATE(rho_updnm1_3)
 LIBPAW_DEALLOCATE(zetm)
 LIBPAW_DEALLOCATE(zetmm1_3)
 LIBPAW_DEALLOCATE(zetp)
 LIBPAW_DEALLOCATE(zetpm1_3)
